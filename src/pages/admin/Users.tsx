...
export default function AdminUsers() {
  ...
  const all = (users.data?.results ?? []).filter(u => {
              ...
              <tbody>
                {all.map(u => (
                  <tr key={u.id}>
                    ...
                    <td>{u.is_verified ? <Badge variant="success">Verified</Badge> : <Badge variant="neutral">Pending</Badge>}</td>
